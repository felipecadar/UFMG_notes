...
## Revisão. Processos, threads, virtualização

1. [parte a](aula-03a.md)
2. [parte b](aula-03b.md)
3. [parte c](aula-03c.md)

## Primitivas para coordenação em memória compartilhada

1. [parte a](aula-04a.md)
2. [parte b](aula-04b.md)

## Problemas clássicos de coordenação

1. [Problemas clássicos de sincronização](aula-05a.md)
